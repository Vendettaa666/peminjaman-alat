...
<div class="max-w-md bg-white p-6 rounded-lg shadow-md">
    <form action="{{ route('kategori.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_kategori" class="w-full p-2 border rounded @error('nama_kategori') border-red-500 @enderror" value="{{ old('nama_kategori') }}" placeholder="Misal: Elektronik">
            @error('nama_kategori')
