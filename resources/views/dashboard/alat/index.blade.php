        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="p-3"><span class="bg-gray-200 px-2 py-1 rounded text-xs">{{ $item->kategori->nama_kategori }}</span></td>
                    <td class="p-3">{{ $item->stok }} unit</td>
                    <td class="p-3 flex justify-center space-x-2">
                        ...
                        <form action="{{ route('alat.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Hapus alat ini?')">
                            @csrf
                            @method('DELETE')
